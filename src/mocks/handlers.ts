...
import { BASE_URL } from "../services/rickandmorty/rickandmorty.service";
import { TRickAndMortyCharacterResponse } from "types/types";

export const characters: TRickAndMortyCharacterResponse = {
  info: {
    count: 826,
    pages: 42,
